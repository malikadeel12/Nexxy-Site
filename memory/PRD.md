...
- v4: Dedicated /manifesto page (pages/Manifesto.jsx) with staggered serif line reveals + CTA; navbar & footer now include "Manifesto" link (all links use /#anchor form); About section manifesto block replaced with teaser card linking to /manifesto
